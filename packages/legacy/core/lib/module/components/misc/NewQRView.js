...
const NewQRView = ({
  ...
  const scanPasteUrl = () => /*#__PURE__*/React.createElement(HeaderButton, {
  ...
  useEffect(() => {
    if ((record === null || record === void 0 ? void 0 : record.state) === DidExchangeState.Completed) {
  ...
  }, firstTabActive ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Modal, {
    visible: showInfoBox,
    animationType: "fade",
    transparent: true
  ...
  }, store.preferences.walletName), /*#__PURE__*/React.createElement(HeaderButton, {
    buttonLocation: ButtonLocation.Right,
  ...
  }, t('Connection.ShareQR'))))), /*#__PURE__*/React.createElement(View, {
