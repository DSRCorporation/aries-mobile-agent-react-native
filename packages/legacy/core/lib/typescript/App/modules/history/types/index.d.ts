...
export declare enum HistorySettingsOptionStorageKey {
...
export declare enum HistoryCardType {
...
export declare enum AppNotificationCardType {
    AppPinReminder = "AppPinReminder"
}
export declare enum NotificationCardType {
    CardExpired = "CardExpired",
    CardRevoked = "CardRevoked"
}
