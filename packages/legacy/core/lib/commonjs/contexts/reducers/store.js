    ...
    case PreferencesDispatchAction.ENABLE_DEVELOPER_MODE:
      {
        ...
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Preferences, JSON.stringify(preferences));
        return {
          ...state,
          preferences
        };
    ...
    case PreferencesDispatchAction.USE_BIOMETRY:
      {
        ...
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Onboarding, JSON.stringify(onboarding));
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Preferences, JSON.stringify(preferences));
        return newState;
      }
    ...
    case ToursDispatchAction.ENABLE_TOURS:
      {
        ...
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Tours, JSON.stringify(tours));
        return newState;
      }
    ...
    case OnboardingDispatchAction.ONBOARDING_VERSION:
      {
        ...
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Onboarding, JSON.stringify(newState.onboarding));
        return newState;
      }
    ...
    case OnboardingDispatchAction.DID_CREATE_PIN:
      {
        ...
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Onboarding, JSON.stringify(newState.onboarding));
        _asyncStorage.default.setItem(_constants.LocalStorageKeys.Migration, JSON.stringify(newState.migration));
        return newState;
      }
