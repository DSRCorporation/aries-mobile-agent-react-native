...
const NameWallet = () => {
  ...
  const onBoardingComplete = store.onboarding.onboardingVersion !== 0 && store.onboarding.didCompleteOnboarding || store.onboarding.onboardingVersion === 0 && store.onboarding.didConsiderBiometry;
  ...
  return /*#__PURE__*/_react.default.createElement(_KeyboardView.default, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    testID: onBoardingComplete ? (0, _testable.testIdWithKey)('Save') : (0, _testable.testIdWithKey)('Continue'),
    accessibilityLabel: onBoardingComplete ? t('Global.Save') : t('Global.Continue'),
    onPress: handleContinuePressed,
    disabled: loading
  }, loading && /*#__PURE__*/_react.default.createElement(_ButtonLoading.default, null)), onBoardingComplete && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      marginTop: 15
    }
  }, /*#__PURE__*/_react.default.createElement(_Button.default, {
...
var _default = exports.default = NameWallet;
//# sourceMappingURL=NameWallet.js.map