...
const CredentialPending = () => {
  ...
  (0, _react.useEffect)(() => {
    ...
    setTimeout(() => {
      _reactNative.Animated.loop(_reactNative.Animated.sequence([_reactNative.Animated.timing(fadeAnim, fadeTiming), _reactNative.Animated.timing(tranAnim, slideTiming)])).start();
    }, animationDelay);
  }, []);
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: style.container
  }, /*#__PURE__*/_react.default.createElement(_walletBack.default, {
    style: style.back,
    height: 110,
    width: 110
