...
exports.getDescriptorMetadata = exports.filterInvalidProofRequestMatches = exports.createAnonCredsProofRequest = void 0;
var _anoncreds = require("@credo-ts/anoncreds");
var _core = require("@credo-ts/core");
// This type seems to be a bit broken now for some reason
...
const createAnonCredsProofRequest = (presentationDefinition, descriptorMetadata) => {
...
exports.createAnonCredsProofRequest = createAnonCredsProofRequest;
const getDescriptorMetadata = credentialsForRequest => {
  ...
  for (const requestedAttribute of Object.values(credentialsForRequest.requirements)) {
    for (const entry of requestedAttribute.submissionEntry) {
      ...
      const recordsWithMetadata = entry.verifiableCredentials.map(submissionEntryCredential => {
        if (submissionEntryCredential.claimFormat !== _core.ClaimFormat.LdpVc) {
        ...
        const anonCredsTags = (0, _anoncreds.getAnonCredsTagsFromRecord)(record);
 ...
 */
exports.getDescriptorMetadata = getDescriptorMetadata;
const filterInvalidProofRequestMatches = (anonCredsCredentialsForRequest, descriptorMetadata) => {
...
exports.filterInvalidProofRequestMatches = filterInvalidProofRequestMatches;
