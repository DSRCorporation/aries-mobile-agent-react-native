...
const TermsVersion = exports.TermsVersion = '1';
const Terms = () => {
  const [store, dispatch] = (0, _store2.useStore)();
  const agreedToPreviousTerms = store.onboarding.didAgreeToTerms;
  const [checked, setChecked] = (0, _react.useState)(agreedToPreviousTerms);
  const {
    t
  ...
  const [Button] = (0, _containerApi.useServices)([_containerApi.TOKENS.COMPONENT_BUTTON]);
  ...
  return /*#__PURE__*/_react.default.createElement(_ScreenLayout.default, {
    screen: _navigators.Screens.Terms
  }, /*#__PURE__*/_react.default.createElement(_reactNative.ScrollView, {
    style: style.container
  }, /*#__PURE__*/_react.default.createElement(_InfoTextBox.default, null, "Please agree to the terms and conditions below before using this application."), /*#__PURE__*/_react.default.createElement(_ThemedText.ThemedText, {
  ...
  }, !(agreedToPreviousTerms && store.authentication.didAuthenticate) && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
