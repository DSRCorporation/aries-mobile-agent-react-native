...
export declare const optionsForKeychainAccess: (service: KeychainServices, useBiometrics?: boolean) => SetOptions;
export declare const secretForPIN: (PIN: string, hashAlgorithm: (PIN: string, salt: string) => Promise<string>, salt?: string) => Promise<WalletSecret>;
...
export declare const loadWalletSecret: (title?: string, description?: string) => Promise<WalletSecret | undefined>;
