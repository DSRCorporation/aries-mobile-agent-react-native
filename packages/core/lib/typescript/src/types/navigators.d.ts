...
export type ProofRequestsStackParams = {
    ...
    [Screens.ProofRequestDetails]: {
        templateId: string;
        connectionId?: string;
    };
    [Screens.MobileVerifierLoading]: {
        proofId: string;
        connectionId: string;
    };
...
export type SettingStackParams = {
    ...
    [Screens.ConfigureMediator]: {
        scannedMediatorUri: string;
    } | undefined;
};
...
export type DeliveryStackParams = {
    ...
    [Screens.OpenIDProofCredentialSelect]: {
        ...
        onCredChange: ({ inputDescriptorID, id, claimFormat, }: {
            inputDescriptorID: string;
            id: string;
            claimFormat: string;
        }) => void;
