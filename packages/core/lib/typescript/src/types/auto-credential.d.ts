 ...
 */
export declare const CredentialProvisioningEventTypes: {
    readonly Started: "CredentialProvisioningEvent.Started";
    readonly Completed: "CredentialProvisioningEvent.Completed";
    readonly FailedHandleOffer: "CredentialProvisioningEvent.FailedHandleOffer";
    readonly FailedHandleProof: "CredentialProvisioningEvent.FailedHandleProof";
    readonly FailedRequestCredential: "CredentialProvisioningEvent.FailedRequestCredential";
};
/**
...
//# sourceMappingURL=auto-credential.d.ts.map