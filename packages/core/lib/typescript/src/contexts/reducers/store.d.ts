...
export declare const DispatchAction: {
    ...
    AUTO_LOCK_TIME: PreferencesDispatchAction.AUTO_LOCK_TIME;
    SET_THEME: PreferencesDispatchAction.SET_THEME;
    SET_SELECTED_MEDIATOR: PreferencesDispatchAction.SET_SELECTED_MEDIATOR;
    ADD_AVAILABLE_MEDIATOR: PreferencesDispatchAction.ADD_AVAILABLE_MEDIATOR;
    RESET_MEDIATORS: PreferencesDispatchAction.RESET_MEDIATORS;
    BANNER_MESSAGES: PreferencesDispatchAction.BANNER_MESSAGES;
    GENERIC_ERROR_MESSAGES: PreferencesDispatchAction.GENERIC_ERROR_MESSAGES;
    REMOVE_BANNER_MESSAGE: PreferencesDispatchAction.REMOVE_BANNER_MESSAGE;
    ...
    DID_CONFIRM_PIN: OnboardingDispatchAction.DID_CONFIRM_PIN;
