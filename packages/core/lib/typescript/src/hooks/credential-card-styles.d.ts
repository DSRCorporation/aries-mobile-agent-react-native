...
declare const useCredentialCardStyles: (overlayOrColors: CredentialOverlay<BrandingOverlay> | SimpleColors, brandingOverlayType?: BrandingKind, proof?: boolean) => {
    styles: {
        container: {
        ...
        primaryBodyContainer: {
            marginLeft: number;
            justifyContent?: "space-between" | undefined;
            flex: number;
            padding: number;
        };
...
//# sourceMappingURL=credential-card-styles.d.ts.map