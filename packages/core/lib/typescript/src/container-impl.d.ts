...
export declare class MainContainer implements Container {
    ...
    private log?;
    private storage;
    constructor(container: DependencyContainer, log?: BifoldLogger);
...
export declare const SystemContext: React.Context<Container | undefined>;
export declare const SystemProvider: React.Provider<Container | undefined>;
