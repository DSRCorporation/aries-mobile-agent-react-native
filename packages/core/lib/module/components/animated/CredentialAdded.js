...
const CredentialAdded = () => {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      if (!(Animated !== null && Animated !== void 0 && Animated.sequence) || !(Animated !== null && Animated !== void 0 && Animated.timing)) {
        return;
      }
      animation.current = Animated.sequence([Animated.timing(cardFadeAnim.current, fadeTiming), Animated.timing(tranAnim.current, slideTiming), Animated.timing(checkFadeAnim.current, fadeTiming)]);
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    height: 45,
    width: 45
  })), /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(Assets.svg.walletBack, {
    style: style.back,
    height: 110,
    width: 110
  }), /*#__PURE__*/React.createElement(Animated.View, {
