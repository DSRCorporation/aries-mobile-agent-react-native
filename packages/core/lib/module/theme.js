...
export const Inputs = createInputsTheme({
  ColorPalette,
  TextTheme,
  borderRadius
});
...
export const Buttons = createButtonsTheme({
  ColorPalette,
  TextTheme
});
...
export const ListItems = createListItemsTheme({
  ColorPalette,
  TextTheme
});
...
export const TabTheme = createTabTheme({
  ColorPalette,
  TextTheme
});
...
export const NavigationTheme = createNavigationTheme({
  ColorPalette
});
...
export const HomeTheme = createHomeTheme({
  ColorPalette,
  TextTheme
});
...
export const SettingsTheme = createSettingsTheme({
  ColorPalette,
  TextTheme
});
...
export const ChatTheme = createChatTheme({
  ColorPalette,
  TextTheme
});
...
export const OnboardingTheme = createOnboardingTheme({
  ColorPalette,
  TextTheme
});
...
export const DialogTheme = createDialogTheme({
  ColorPalette
});
...
export const LoadingTheme = createLoadingTheme({
  ColorPalette
});
...
export const PINInputTheme = createPINInputTheme({
  ColorPalette
});
...
export const SeparatedPINInputTheme = createSeparatedPINInputTheme({
  ColorPalette
});
...
export const InputInlineMessage = createInputInlineMessageTheme({
  TextTheme,
  Assets
});
