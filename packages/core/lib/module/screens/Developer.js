...
const Developer = () => {
  ...
  const onRunRefreshCycleTouched = () => {
    ...
    (_navigation$getParent = navigation.getParent()) === null || _navigation$getParent === void 0 || _navigation$getParent.navigate(Stacks.TabStack, {
      screen: Screens.Home
    });
    setTimeout(() => {
  ...
  }, "Place content here you would like to make available to developers when developer mode is enabled."), /*#__PURE__*/React.createElement(DeveloperToggleRow, {
  ...
  }), /*#__PURE__*/React.createElement(DeveloperToggleRow, {
  ...
  }), !store.onboarding.didCreatePIN && /*#__PURE__*/React.createElement(DeveloperToggleRow, {
