...
const ProofRequestsCard = ({
  ...
  return meta ? /*#__PURE__*/React.createElement(TouchableOpacity, {
    ...
    numberOfLines: 1
  }, meta.name), /*#__PURE__*/React.createElement(ThemedText, {
    style: style.templateDetails,
    numberOfLines: 2
  }, meta.description), hasPredicates(template) && /*#__PURE__*/React.createElement(ThemedText, {
    style: style.templateZkpLabel
  }, t('Verifier.ZeroKnowledgeProof')), isParameterizable(template) && /*#__PURE__*/React.createElement(ThemedText, {
    style: style.templateZkpLabel
