...
const TabStack: React.FC = () => {
  ...
  const [HomeStack, { useNotifications }, { enableImplicitInvitations, enableReuseConnections }, logger, CredentialStack] = useServices([
    TOKENS.STACK_HOME, TOKENS.NOTIFICATIONS,
    TOKENS.CONFIG,
    TOKENS.UTIL_LOGGER,
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: NavigationTheme.colors.background }} edges={['left', 'right', 'top']}>
      <Tab.Navigator
