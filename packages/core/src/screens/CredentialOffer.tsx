...
const CredentialOffer: React.FC<CredentialOfferProps> = ({ navigation, credentialId }) => {
  ...
  const [
    CredentialCard, bundleResolver, { enableTours: enableToursConfig }, logger, historyManagerCurried,
    historyEnabled,
    historyEventsLogger,
  ] = useServices([
    TOKENS.COMPONENT_CREDENTIAL_CARD, TOKENS.UTIL_OCA_RESOLVER, TOKENS.CONFIG, TOKENS.UTIL_LOGGER, TOKENS.FN_LOAD_HISTORY,
